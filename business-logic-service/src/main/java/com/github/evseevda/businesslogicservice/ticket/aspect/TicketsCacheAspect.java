package com.github.evseevda.businesslogicservice.ticket.aspect;

import com.github.evseevda.businesslogicservice.core.cache.redis.adapter.RedisTemplateAdapter;
import com.github.evseevda.businesslogicservice.core.cache.util.CacheKey;
...
public class TicketsCacheAspect {
    ...
    @Around("""
                execution(java.util.stream.Stream<com.github.evseevda.businesslogicservice.ticket.entity.Ticket>
                com.github.evseevda.businesslogicservice.ticket.service.TicketService.findCurrentUserTickets(..))
            """)
    ...
    @Around("execution(com.github.evseevda.businesslogicservice.ticket.entity.Ticket com.github.evseevda.businesslogicservice.ticket.service.TicketService.buyTicket(..))")
